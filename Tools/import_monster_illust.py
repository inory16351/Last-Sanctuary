...
ILLUSTS = [
    ...
    # ★ 웨이브 보스 레기미아(120006) — 2026-08-21. 원본 이름이 표
    #   (`wave_top_boss.illust` = `Legimia_illust`)와 같아서 바로잡을 것이 없다.
    #   폴더는 다른 웨이브 보스들과 같은 `monster_cancer` 다.
    (os.path.join("monster_cancer", "Legimia_illust.png"),                    "Legimia_illust"),
]
