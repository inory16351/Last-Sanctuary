...
namespace LastSanctuary.Units
{
    ...
    /// <c>spawn_range_min</c> / <c>spawn_range_max</c> 두 칸이 정본이고, 값은 <b>성역을 중심에 둔
    ...
    public class NeutralMonsterSpawner : MonoBehaviour
    {
        ...
        ///
        /// 320×320 맵은 성역(중심)에서 축 방향으로 158타일, <b>모서리까지 약 223타일</b>이다.
                                     ...
                                     float minDist, float maxDist, int habitatSeed, int spawnId)
        {
            ...
            // ★ 에픽은 <b>성역 고리가 아니라 자기 스폰 지점</b>이 기준이다 (유저 지시 2026-08-15).
        ...
        /// <summary>
        /// 성역(셀 (0,0)) 중심 <b>정사각 고리</b>(변 min ~ 변 max 타일) 안에서 배치 가능한 칸을
        /// 무작위로 찾는다.
        ///
        ...
        /// 되고(15 → 성역에서 ±7.5), 숫자를 하나도 고칠 필요가 없다 —
        ...
        /// <summary>
        /// 성역(맵 중심)에서 맵 안의 한 점까지 나올 수 있는 <b>최대 체비셰프 거리</b>(타일) —
        ...
        /// (유저 확정 2026-08-13: "성역 기준 타일 범위로 360도 원형").
        ///
        /// <b>왜 반지름을 √ 로 뽑는가</b> — 각도를 균일하게 뽑고 반지름을 그냥 <c>Lerp</c> 로
        /// 뽑으면 <b>안쪽이 좁고 바깥이 넓은데 같은 수를 뿌리게</b> 되어 개체가 성역 쪽으로
        ...
        /// <summary>
        /// 성역(셀 (0,0))로부터의 <b>체비셰프 거리</b>(타일) — max(|x|, |y|).
        ///
