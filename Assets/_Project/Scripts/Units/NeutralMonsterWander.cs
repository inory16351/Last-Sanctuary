...
namespace LastSanctuary.Units
{
    ...
    /// <c>spawn_range_max</c> 로 정해지는 <b>성역 중심의 360도 원형 고리</b>(유클리드 거리)다.
    ...
    public class NeutralMonsterWander : MonoBehaviour
    {
        ...
        [Tooltip("★ 한 번에 움직이는 거리(타일). <b>재추첨 주기 안에 걸어서 닿을 수 있는 거리</b>여야 한다.\n" +
                 ...
                 "닿기 전에 다음 목표가 뽑혀 <b>영영 도착하지 못하고 고리의 무게중심(=성역)으로 " +
        ...
        //
        // ⚠ 중심을 <b>스폰 지점으로 고정</b>하는 것이 핵심이다. 성역 기준으로 두면 맵
        //   반대편의 에픽 둘이 같은 고리를 공유해 "자기 자리" 라는 개념이 생기지 않는다.
        // ==================================================================

        /// <summary>서식지 모드인가. 켜지면 중심이 성역이 아니라 <see cref="_habitatCenter"/> 다.</summary>
        bool _habitatMode;
        ...
        /// 서식지 모드는 <b>자기 스폰 지점</b>이 중심이고, 아니면 <b>성역 고리</b>가 중심이라
        /// 개체마다 따로 기억할 집이 없다.
        /// </summary>
        ...
        /// <summary>
        /// 고리·복귀 판정의 <b>중심</b>. 서식지 모드면 스폰 지점, 아니면 성역.
        ...
        /// <b>움직이지 않는 기준(성역 중심 고리)</b> 으로 다시 잡는다.
        ///
        ...
        ///   조금씩 걷는 것은 곧 <b>고리의 무게중심(=성역)으로 가는 랜덤워크</b>다
        /// </code>
        ///
        /// 실제로 시뮬레이션하면 고리 100~160 짜리 개체가 <b>성역에서 18~70타일</b>까지
        ...
        /// <summary>
        /// 그 지점을 <b>성역 기준 고리 안</b>으로 접어 넣는다 — 방향은 그대로 두고
        ...
        /// x·y 를 같은 비율로</b> 줄이거나 늘린다. 그러면 방향(성역에서 본 각도)이 유지된 채
        /// 정사각 테두리 위로 정확히 옮겨진다.
